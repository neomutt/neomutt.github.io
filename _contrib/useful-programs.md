...
* [ciscoclean](https://www.sthu.org/code/codesnippets/mutt-cisco-url-rewriting-clean.html)
  -- display filter to restore original URL from the URL generated by Cisco's mail security software. 
* [muttutils](https://hg.phloxic.productions/muttils) -- various utilities for mutt.
